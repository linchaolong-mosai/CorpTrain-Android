...
public final class AppUtils {
     ...
     * @return
     */
    public static Signature getAppSign(Context context) {
        PackageInfo pi;
        Signature sign = null;
        try {
     ...
     * @return
     */
    public static boolean isSignCheckWithHashCode(Context context, int presetHashCode) {
        Signature signature = getAppSign(context);

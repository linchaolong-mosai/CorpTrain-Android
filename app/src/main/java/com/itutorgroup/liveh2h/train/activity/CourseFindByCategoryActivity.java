...
public class CourseFindByCategoryActivity extends BaseToolbarActivity {
  ...
  private List<Courses> courseFindByCategories = new ArrayList<>();
  ...
  protected void initDatas() {
    courseFindByCategoryAdapter = new CourseFindByCategoryAdapter(context, courseFindByCategories,
        R.layout.item_listformat_course_searchresult);
  ...
  private void getDatas(final boolean showTips) {
    AppAction.getCourselist(context, categoryId,
        new HttpResponseHandler(context, CoursesFindByCategory.class) {
          @Override public void onResponeseSucess(int statusCode, HttpResponse response,

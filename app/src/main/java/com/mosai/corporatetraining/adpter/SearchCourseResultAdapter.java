...
import com.mosai.corporatetraining.bean.usercourse.CourseInfo;
 ...
 */
public class SearchCourseResultAdapter extends CommonAdapter<Courses>{
    private DisplayImageOptions options;
    public SearchCourseResultAdapter(Context context, List<Courses> listDatas, int layoutId) {
